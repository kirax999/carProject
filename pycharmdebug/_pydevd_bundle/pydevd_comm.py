...
from _pydevd_bundle.pydevd_constants import DebugInfoHolder, dict_contains, get_thread_id, IS_JYTHON, IS_PY2, IS_PY3K, \
    STATE_RUN
...
VERSION_STRING = "PY-171.4163.6"

from pycharmdebug._pydev_bundle._pydev_filesystem_encoding import getfilesystemencoding
