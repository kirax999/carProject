...
class Test(unittest.TestCase):
    ...
    def testProcessCommandLine(self):
        from pycharmdebug._pydevd_bundle.pydevd_command_line_handling import process_command_line, setup_to_argv
    ...
    def testProcessCommandLine2(self):
        from pycharmdebug._pydevd_bundle.pydevd_command_line_handling import process_command_line
