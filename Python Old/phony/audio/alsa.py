...
class Alsa(ClassLogger):
    ...
    def _show_properties(self):
        ...
        """data = self._speaker_mixer.getvolume()"""
        self.log().debug('Speaker playback volume: %s' % self._speaker_mixer.getvolume())
        ...
        self.log().debug('Microphone playback volume: %s' % self._microphone_mixer.getvolume())
        self.log().debug('Microphone capture volume: %s' % self._microphone_mixer.getvolume())
